              ...
              children: [
                ...
                Row(
                  ...
                  children: const [
                    ...
                    Expanded(flex: 2, child: Text("Product", textAlign: TextAlign.center,)),
                ...
                Row(
                  ...
                  children: const [
                    Expanded(flex: 3, child: Text("Total Payment:",textAlign: TextAlign.center, style:TextStyle(fontWeight: FontWeight.bold))),
                    Expanded(flex: 2, child: Text("",textAlign: TextAlign.center)),
                    Expanded(flex: 2, child: Text("",textAlign: TextAlign.center)),
                    Expanded(flex: 2, child: Text("",textAlign: TextAlign.center)),
                    Expanded(flex: 2, child: Text("570" + "₺",textAlign: TextAlign.center,style: TextStyle(color: Colors.green, fontSize: 15, fontWeight: FontWeight.bold))),
                  ],
                ),
                const SizedBox(
                  height: 20,
